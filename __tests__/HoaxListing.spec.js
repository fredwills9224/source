...
describe('Listing All Hoaxes', ()=>{
    ...
    it('returns only id, content, timestamp, and user object having id, username, email, and image in content array for each hoax', 
        async ()=>{
    ...
    it('returns second page hoaxes and page indicator when page is set as 1 in request parameter', 
        async ()=>{
    ...
    it('returns 5 hoaxes and corresponding size indicator when size is set as 5 in request parameter',
        async ()=>{
...
describe('Listing Hoaxes of a User', ()=>{
    ...
    it.each`
        ...
        `('returns error object with $message for unkown user when language is $language', 
    ...
    it('returns 5 hoaxes belongs to user in page content when there are total 11 hoaxes for two users',
        async ()=>{
