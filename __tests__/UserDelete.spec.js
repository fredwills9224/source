...
describe('User Delete', ()=>{
    ...
    // // [validUser]
        ...
        it('deletes all tokens from database when delete user request sent from authorized user',
            async ()=>{
        ...
        it('deletes hoax from database when delete user request sent from authorized user',
            async ()=>{
    ...
    it('deletes hoax attachment from storage and database when delete user request sent from authorized user',
        async ()=>{
